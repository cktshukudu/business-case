...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('btamplate', '0004_alter_createform_table'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Business_case_proposal_date', models.DateField(default=django.utils.timezone.now)),
                ...
                ('Proposed_Start_Date', models.DateField(default=django.utils.timezone.now)),
                ('Overall_Project_Timeframe', models.DateField(default=django.utils.timezone.now)),
                ('Estimated_completion_Date', models.DateField(default=django.utils.timezone.now)),
