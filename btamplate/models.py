...
class Form(models.Model):
    ...
    Business_case_proposal_date =  models.DateField(default=timezone.now)
    ...
    Proposed_Start_Date =  models.DateField(default=timezone.now)
    Overall_Project_Timeframe =  models.DateField(default=timezone.now)
    Estimated_completion_Date = models.DateField(default=timezone.now)
